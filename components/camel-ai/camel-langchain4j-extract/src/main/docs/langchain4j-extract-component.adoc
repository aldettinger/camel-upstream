= langChain4j Extract Component
:doctitle: langChain4j Extract
:shortname: langchain4j-extract
:artifactid: camel-langchain4j-extract
:description: LangChain4j Extract component
:since: 4.5
:supportlevel: Stable
:tabs-sync-option:
